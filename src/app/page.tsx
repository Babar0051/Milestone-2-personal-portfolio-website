...
export default function Home() {
  return (
    ...
    <div className="md:w-1/2 ml-40 align-right">
        <img src="https://i.ibb.co/d526yWr/IMG-20231030-WA0003-my-pic-1-removebg-preview-removebg-preview.png" alt="Babar Ahmed" className="rounded-full shadow-lg w-full md:w-1/2 h-auto" />
    </div>
</div>
    <Footer/>
